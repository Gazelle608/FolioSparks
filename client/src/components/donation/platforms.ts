...
import { PatreonIcon, KofiIcon, BmacIcon } from "../../assets/icons";
...
function PaypalGlyph({ size = 24, className = "" }: { size?: number; className?: string }): ReactElement {
  return createElement("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "currentColor", className, "aria-hidden": true },
    createElement("path", { d: "M7.5 3h6.6c3.2 0 5.2 1.6 4.7 4.7-.5 3.3-2.9 4.8-6 4.8H10l-.9 6H5.5L7.5 3zm3.7 7.5h1.6c1.5 0 2.7-.6 2.9-2.1.2-1.4-.7-1.8-2-1.8h-1.7l-.8 3.9z" }),
    createElement("path", { d: "M12 11.4h1.3c2.5 0 3.4 1.3 3 3.4-.3 2.2-2 3-4.3 3H9.5l-.9 5.7H6l2.4-15.7h2.4L12 11.4z", opacity: "0.6" }));
}

function StripeGlyph({ size = 24, className = "" }: { size?: number; className?: string }) {
  return createElement("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", className, "aria-hidden": true },
    createElement("rect", { x: "2", y: "4", width: "20", height: "16", rx: "3", fill: "currentColor" }),
    createElement("path", { d: "M11.4 9.2c-.7-.3-1.1-.5-1.1-.8 0-.3.2-.4.6-.4.5 0 1.1.2 1.6.4l.3-1.5c-.4-.2-1-.3-1.7-.3-1.6 0-2.7.8-2.7 2.2 0 .9.6 1.5 1.6 2 .6.3.8.4.8.8 0 .3-.2.5-.7.5-.6 0-1.4-.3-2-.6l-.3 1.5c.6.3 1.4.5 2.2.5 1.7 0 2.8-.8 2.8-2.2 0-.9-.5-1.5-1.4-2.1z", fill: "#DAF1DE" }));
}

function CashAppGlyph({ size = 24, className = "" }: { size?: number; className?: string }) {
  return createElement("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "currentColor", className, "aria-hidden": true }, createElement("path", { d: "M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm1.6 15.8v-1c-1.4 0-2.7-.4-3.6-1l.7-1.8c.9.5 2 .9 3 .8 1 0 1.6-.4 1.6-.9 0-.6-.6-.9-2-1.3-2.1-.6-3.5-1.5-3.5-3.3 0-1.6 1.1-2.8 2.9-3.2v-1h1.7v1c1.2 0 2.2.3 3 .8l-.7 1.8c-.8-.4-1.7-.6-2.6-.6-.9 0-1.5.3-1.5.8s.6.8 2.1 1.2c2.1.6 3.4 1.5 3.4 3.4 0 1.7-1.2 3-3.2 3.4v1h-1.3z" }));
}

function VenmoGlyph({ size = 24, className = "" }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M19.5 3c.3 1 .5 2.1.5 3.5 0 4.3-3.7 10-6.7 14H6.7L3.5 3.4l5.5-.5 1.7 13.6c1.6-2.6 3.6-6.7 3.6-9.5 0-1.5-.3-2.6-.7-3.4L19.5 3z" />
    </svg>
  );
}

function CustomGlyph({ size = 24, className = "" }: { size?: number; className?: string }) {
  return (
