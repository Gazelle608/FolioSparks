...
/**
 * @param nextPath Optional same-origin path to return to after the user
 *   clicks the confirmation link in their email (carried in the link's
 *   redirect URL so it survives the email round trip).
 */
