...
import type { DonationLinkDraft } from "../components/auth/onboarding/donationplatformpicker";
...
import { DonationPlatformPicker } from "../components/auth/onboarding/donationplatformpicker";
...
function useAuth(): { user: any; isAuthor: any; loading: any } {
  ...
  return { user, isAuthor: role === "author", loading };
}
